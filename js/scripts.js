$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'd33beff2be7bfea4d22d00c9a2ccc5fc'
            ...
            $.post('https://script.google.com/macros/s/AKfycbxMe0MkKmJN8Bf_6oUZ4ONSpDQl9w13WOPy1rCdCFfaEgR4I2Y/exec', data)
                .done(function (data) {
                    console.log(data);
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', '<strong>Miala tsiny!</strong> Misy ny olana mikasika ny mpizara. '));
                });
        }
    });
